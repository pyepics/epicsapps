...
class TestFrame(wx.Frame):
    def __init__(self, parent, ID, *args,**kwds):
        ...
        b22 = wx.Button(panel, -1, 'Plot 2x2',   size=(-1,-1))
        ...
        b22.Bind(wx.EVT_BUTTON,self.onPlot2x2)
    ...
    def onPlot2x2(self,event=None):
        self.ShowPlotFrame()
        self.plotframe.plot(self.x,self.y2,color='red',style='solid',
                            label='y1', ylabel='y1')
        self.plotframe.plotpanel.set_y2label('y2')
        self.plotframe.oplot(self.x,22*self.y3, side='right',label='y2',
                             color='blue',style='dashed', markersize=14)
        self.plotframe.write_message("Plot 2x2")
