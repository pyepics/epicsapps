...
The main applications included in EpicsApps are:
  ...
  * :ref:`adviewer`: A GUI application to view live images and have basic
  ...
  * :ref:`pvaviewer`: (Work-in-Progress!) A GUI application to view
    live images from Epics Area Detector using the Epics PVA protocal
    instead of CA.
